...
public final class PhoneNumberUtils {
   ...
   *
   * <ol>
   *   <li>When the android version is LOLLIPOP or greater, the reliable {{@link
   *       android.telephony.PhoneNumberUtils#formatNumberToE164}} is used to format.
   *   <li>For lower versions, we construct a value with the input phone number stripped of non
   *       numeric characters and prefix it with a "+" and country code
   * </ol>
   *
  ...
  /**
   * This method uses the country returned by {@link #getCurrentCountryInfo(Context)} to format the
   * phone number. Internally invokes {@link #format(String, CountryInfo)}
   *
   * @param phoneNumber that may or may not itself have country code
   */
  @Nullable
  ...
  public static PhoneNumber getPhoneNumber(
    ...
    return new PhoneNumber(providedNationalNumber, providedCountryIso, String.valueOf(countryCode));
  }
